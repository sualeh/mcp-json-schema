...
public class DeserializationUtility {
  ...
  public static JsonNode toJsonObject(final String argumentsString) {
    try {
      ...
      LOGGER.log(Level.INFO, () -> "Expected JSON object for arguments but received: " + node);
      return mapper.createObjectNode();
  ...
  public static <P> P instantiateArguments(
    ...
    try {
      ...
      LOGGER.log(Level.INFO, e, () -> String.format(parametersClass.getName(), argumentsString));
      return null;
    }
  }
